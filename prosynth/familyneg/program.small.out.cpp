...
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_13_haschild_info_7 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<10,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_13_haschild_info_7;
// -- Table: haschild.@info.8
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_14_haschild_info_8 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<11,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_14_haschild_info_8;
...
wrapper_rel_13_haschild_info_7(*rel_13_haschild_info_7,symTable,"haschild.@info.7",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}),

wrapper_rel_14_haschild_info_8(*rel_14_haschild_info_8,symTable,"haschild.@info.8",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}),
...
in file /home/johannes_tantow/DatalogLearning/prosynth/familyneg/sol_haschild.dl [19:1-19:71])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/familyneg/sol_haschild.dl [21:1-21:72])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/familyneg/sol_haschild.dl [22:1-22:71])_");
if(!(rel_1_Ihaschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
in file /home/johannes_tantow/DatalogLearning/prosynth/familyneg/sol_haschild.dl [23:1-23:71])_");
if(!(rel_1_Ihaschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
in file /home/johannes_tantow/DatalogLearning/prosynth/familyneg/sol_haschild.dl [25:1-25:51])_");
...
SignalHandler::instance()->setMsg(R"_(haschild(v0,v1,9,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   Ihaschild(v2,v0,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/familyneg/sol_haschild.dl [26:1-26:71])_");
if(!(rel_1_Ihaschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
auto range = rel_1_Ihaschild->equalRange_1(key,READ_OP_CONTEXT(rel_1_Ihaschild_op_ctxt));
for(const auto& env2 : range) {
Tuple<RamDomain,4> tuple({{static_cast<RamDomain>(env2[1]),static_cast<RamDomain>(env1[1]),static_cast<RamDomain>(RamDomain(9)),static_cast<RamDomain>((std::max({std::max({env0[2], env1[3], }), env2[3], })) + (RamDomain(1)))}});
rel_4_haschild->insert(tuple,READ_OP_CONTEXT(rel_4_haschild_op_ctxt));
}
}
}
...
in file /home/johannes_tantow/DatalogLearning/prosynth/familyneg/sol_haschild.dl [18:1-18:70])_");
...
SignalHandler::instance()->setMsg(R"_(haschild(v0,v1,3,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   ismarriedto(v0,v2,_,@level_num_1),
   haschild(v1,v2,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/familyneg/sol_haschild.dl [20:1-20:70])_");
if(!(rel_5_delta_haschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
in file /home/johannes_tantow/DatalogLearning/prosynth/familyneg/sol_haschild.dl [24:1-24:70])_");
if(!(rel_5_delta_haschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
/* BEGIN STRATUM 4 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.1(1,"v0,v1","Rule","ismarriedto,v2,v0","haschild,v1,v2","haschild(v0,v1) :- 
   Rule(128),
   ismarriedto(v2,v0),
   haschild(v1,v2).").
in file  [0:0-0:0])_");
...
/* BEGIN STRATUM 5 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.2(2,"v0,v1","Rule","ismarriedto,v2,v0","Ihaschild,v1,v2","haschild(v0,v1) :- 
   Rule(104),
   ismarriedto(v2,v0),
   Ihaschild(v1,v2).").
in file  [0:0-0:0])_");
rel_8_haschild_info_2->insert(RamDomain(2),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(5),RamDomain(6));
}();
/* END STRATUM 5 */
/* BEGIN STRATUM 6 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.3(3,"v0,v1","Rule","ismarriedto,v0,v2","haschild,v1,v2","haschild(v0,v1) :- 
   Rule(130),
   ismarriedto(v0,v2),
   haschild(v1,v2).").
in file  [0:0-0:0])_");
rel_9_haschild_info_3->insert(RamDomain(3),RamDomain(0),RamDomain(1),RamDomain(7),RamDomain(3),RamDomain(8));
}();
/* END STRATUM 6 */
/* BEGIN STRATUM 7 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.4(4,"v0,v1","Rule","ismarriedto,v0,v2","ismarriedto,v1,v2","haschild(v0,v1) :- 
   Rule(94),
   ismarriedto(v0,v2),
   ismarriedto(v1,v2).").
in file  [0:0-0:0])_");
rel_10_haschild_info_4->insert(RamDomain(4),RamDomain(0),RamDomain(1),RamDomain(7),RamDomain(9),RamDomain(10));
}();
/* END STRATUM 7 */
/* BEGIN STRATUM 8 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.5(5,"v0,v1","Rule","ismarriedto,v2,v0","Ihaschild,v2,v1","haschild(v0,v1) :- 
   Rule(105),
   ismarriedto(v2,v0),
   Ihaschild(v2,v1).").
in file  [0:0-0:0])_");
rel_11_haschild_info_5->insert(RamDomain(5),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(11),RamDomain(12));
}();
/* END STRATUM 8 */
/* BEGIN STRATUM 9 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.6(6,"v0,v1","Rule","ismarriedto,v1,v2","Ihaschild,v2,v0","haschild(v0,v1) :- 
   Rule(103),
   ismarriedto(v1,v2),
   Ihaschild(v2,v0).").
in file  [0:0-0:0])_");
rel_12_haschild_info_6->insert(RamDomain(6),RamDomain(0),RamDomain(1),RamDomain(9),RamDomain(13),RamDomain(14));
}();
/* END STRATUM 9 */
/* BEGIN STRATUM 10 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.7(7,"v0,v1","Rule","ismarriedto,v1,v2","haschild,v2,v0","haschild(v0,v1) :- 
   Rule(127),
   ismarriedto(v1,v2),
   haschild(v2,v0).").
in file  [0:0-0:0])_");
rel_13_haschild_info_7->insert(RamDomain(7),RamDomain(0),RamDomain(1),RamDomain(9),RamDomain(15),RamDomain(16));
}();
/* END STRATUM 10 */
/* BEGIN STRATUM 11 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.8(8,"v0,v1","Rule","ismarriedto,v0,v1","haschild(v0,v1) :- 
   Rule(78),
   ismarriedto(v0,v1).").
in file  [0:0-0:0])_");
rel_14_haschild_info_8->insert(RamDomain(8),RamDomain(0),RamDomain(1),RamDomain(17),RamDomain(18));
}();
/* END STRATUM 11 */
/* BEGIN STRATUM 12 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.9(9,"v0,v1","Rule","ismarriedto,v2,v1","Ihaschild,v2,v0","haschild(v0,v1) :- 
   Rule(108),
   ismarriedto(v2,v1),
   Ihaschild(v2,v0).").
in file  [0:0-0:0])_");
rel_15_haschild_info_9->insert(RamDomain(9),RamDomain(0),RamDomain(1),RamDomain(19),RamDomain(13),RamDomain(20));
}();
/* END STRATUM 12 */
/* BEGIN STRATUM 13 */
[&]() {
