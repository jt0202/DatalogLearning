...
// -- Table: @delta_created
std::unique_ptr<t_btree_4__1_0_2_3__2__15> rel_4_delta_created = std::make_unique<t_btree_4__1_0_2_3__2__15>();
// -- Table: @new_created
std::unique_ptr<t_btree_4__1_0_2_3__2__15> rel_5_new_created = std::make_unique<t_btree_4__1_0_2_3__2__15>();
// -- Table: created.@info.1
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_6_created_info_1 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<3,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_6_created_info_1;
// -- Table: inv_0
...
wrapper_rel_6_created_info_1(*rel_6_created_info_1,symTable,"created.@info.1",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}),
...
addRelation("created",&wrapper_rel_3_created,false,true);
addRelation("created.@info.1",&wrapper_rel_6_created_info_1,false,false);
...
/* BEGIN STRATUM 2 */
[&]() {
rel_4_delta_created->insertAll(*rel_3_created);
iter = 0;
for(;;) {
...
in file /home/johannes/DatalogLearning/prosynth/filmsneg5/rule.dl [53:1-53:64])_");
if(!(rel_4_delta_created->empty()) && !(rel_2_actedin->empty()) && !(rel_1_Rule->empty())) {
[&](){
...
CREATE_OP_CONTEXT(rel_4_delta_created_op_ctxt,rel_4_delta_created->createContext());
CREATE_OP_CONTEXT(rel_5_new_created_op_ctxt,rel_5_new_created->createContext());
pfor(auto it = part.begin(); it<part.end(); ++it) { 
try{
for(const auto& env0 : *it) {
for(const auto& env1 : *rel_2_actedin) {
const Tuple<RamDomain,4> key({{0,env1[1],0,0}});
auto range = rel_4_delta_created->equalRange_2(key,READ_OP_CONTEXT(rel_4_delta_created_op_ctxt));
for(const auto& env2 : range) {
if( !([&]() -> bool {
auto existenceCheck = rel_3_created->equalRange_3(Tuple<RamDomain,4>({{env1[0],env2[0],0,0}}),READ_OP_CONTEXT(rel_3_created_op_ctxt));
...
rel_5_new_created->insert(tuple,READ_OP_CONTEXT(rel_5_new_created_op_ctxt));
}
}
}
}
...
();}
if(rel_5_new_created->empty()) break;
rel_3_created->insertAll(*rel_5_new_created);
std::swap(rel_4_delta_created, rel_5_new_created);
rel_5_new_created->purge();
iter++;
}
iter = 0;
if (!isHintsProfilingEnabled()) rel_4_delta_created->purge();
if (!isHintsProfilingEnabled()) rel_5_new_created->purge();
if (performIO) {
...
/* BEGIN STRATUM 3 */
[&]() {
SignalHandler::instance()->setMsg(R"_(created.@info.1(1,"v0,v1","Rule","actedin,v0,v2","created,v1,v2","created(v0,v1) :- 
   Rule(490),
   actedin(v0,v2),
   created(v1,v2).").
in file  [0:0-0:0])_");
rel_6_created_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3),RamDomain(4));
}();
/* END STRATUM 3 */
/* BEGIN STRATUM 4 */
[&]() {
...
std::cout << "\n";
std::cout << "Relation rel_4_delta_created:\n";
rel_4_delta_created->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_5_new_created:\n";
rel_5_new_created->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_6_created_info_1:\n";
rel_6_created_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
...
std::mutex lock;
if(!(rel_3_created->empty()) && !(rel_2_actedin->empty()) && !(rel_1_Rule->empty())) {
[&](){
const Tuple<RamDomain,3> key({{RamDomain(490),0,0}});
auto range = rel_1_Rule->equalRange_1(key);
auto part = range.partition();
