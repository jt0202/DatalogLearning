...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:1-27:69])_");
...
SignalHandler::instance()->setMsg(R"_(actedin(v0,v1,2,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   Iactedin(v2,v0,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:69-27:134])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:198-27:245])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:440-27:508])_");
if(!(rel_1_Iactedin->empty()) && !(rel_5_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:571-27:618])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:618-27:664])_");
...
SignalHandler::instance()->setMsg(R"_(actedin(v0,v1,12,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   Iactedin(v2,v0,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:664-27:732])_");
if(!(rel_1_Iactedin->empty()) && !(rel_5_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:732-27:796])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:863-27:928])_");
...
SignalHandler::instance()->setMsg(R"_(actedin(v0,v1,16,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   Iactedin(v2,v0,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:928-27:992])_");
if(!(rel_1_Iactedin->empty()) && !(rel_3_created->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
SignalHandler::instance()->setMsg(R"_(actedin(v0,v1,17,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   Iactedin(v2,v0,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:992-27:1057])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:134-27:198])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:245-27:312])_");
...
SignalHandler::instance()->setMsg(R"_(actedin(v0,v1,6,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   actedin(v1,v2,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:312-27:376])_");
...
SignalHandler::instance()->setMsg(R"_(actedin(v0,v1,7,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   actedin(v1,v2,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:376-27:440])_");
...
SignalHandler::instance()->setMsg(R"_(actedin(v0,v1,9,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   actedin(v1,v2,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:508-27:571])_");
...
SignalHandler::instance()->setMsg(R"_(actedin(v0,v1,14,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   ismarriedto(v2,v0,_,@level_num_1),
   actedin(v1,v2,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:796-27:863])_");
if(!(rel_8_delta_actedin->empty()) && !(rel_5_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
SignalHandler::instance()->setMsg(R"_(actedin(v0,v1,18,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   created(v2,v1,_,@level_num_1),
   actedin(v0,v2,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/films/solution.dl [27:1057-27:1120])_");
if(!(rel_8_delta_actedin->empty()) && !(rel_3_created->empty()) && !(rel_2_Rule->empty())) {
[&](){
