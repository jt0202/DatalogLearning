...
// -- Table: actedin
std::unique_ptr<t_btree_4__0_1_2_3__1__3__15> rel_2_actedin = std::make_unique<t_btree_4__0_1_2_3__1__3__15>();
souffle::RelationWrapper<1,t_btree_4__0_1_2_3__1__3__15,Tuple<RamDomain,4>,4> wrapper_rel_2_actedin;
// -- Table: ismarriedto
std::unique_ptr<t_btree_4__0_1_2_3__3__15> rel_3_ismarriedto = std::make_unique<t_btree_4__0_1_2_3__3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_ismarriedto;
// -- Table: @delta_ismarriedto
std::unique_ptr<t_btree_4__1_0_2_3__2__15> rel_4_delta_ismarriedto = std::make_unique<t_btree_4__1_0_2_3__2__15>();
// -- Table: @new_ismarriedto
std::unique_ptr<t_btree_4__1_0_2_3__2__15> rel_5_new_ismarriedto = std::make_unique<t_btree_4__1_0_2_3__2__15>();
// -- Table: inv_0
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_6_inv_0 = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<3,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_6_inv_0;
// -- Table: ismarriedto.@info.1
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_7_ismarriedto_info_1 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<4,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_7_ismarriedto_info_1;
public:
Sf_rule_small() : 
...
wrapper_rel_7_ismarriedto_info_1(*rel_7_ismarriedto_info_1,symTable,"ismarriedto.@info.1",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}){
addRelation("Rule",&wrapper_rel_1_Rule,true,false);
addRelation("actedin",&wrapper_rel_2_actedin,true,false);
addRelation("ismarriedto",&wrapper_rel_3_ismarriedto,false,true);
addRelation("inv_0",&wrapper_rel_6_inv_0,false,true);
addRelation("ismarriedto.@info.1",&wrapper_rel_7_ismarriedto_info_1,false,false);
}
~Sf_rule_small() {
}
private:
...
/* BEGIN STRATUM 2 */
[&]() {
rel_4_delta_ismarriedto->insertAll(*rel_3_ismarriedto);
iter = 0;
for(;;) {
...
in file /home/johannes_tantow/DatalogLearning/prosynth/films/rule.dl [53:1-53:72])_");
if(!(rel_4_delta_ismarriedto->empty()) && !(rel_2_actedin->empty()) && !(rel_1_Rule->empty())) {
[&](){
...
CREATE_OP_CONTEXT(rel_4_delta_ismarriedto_op_ctxt,rel_4_delta_ismarriedto->createContext());
CREATE_OP_CONTEXT(rel_5_new_ismarriedto_op_ctxt,rel_5_new_ismarriedto->createContext());
pfor(auto it = part.begin(); it<part.end(); ++it) { 
try{
for(const auto& env0 : *it) {
for(const auto& env1 : *rel_2_actedin) {
const Tuple<RamDomain,4> key({{0,env1[1],0,0}});
auto range = rel_4_delta_ismarriedto->equalRange_2(key,READ_OP_CONTEXT(rel_4_delta_ismarriedto_op_ctxt));
for(const auto& env2 : range) {
if( !([&]() -> bool {
auto existenceCheck = rel_3_ismarriedto->equalRange_3(Tuple<RamDomain,4>({{env1[0],env2[0],0,0}}),READ_OP_CONTEXT(rel_3_ismarriedto_op_ctxt));
...
rel_5_new_ismarriedto->insert(tuple,READ_OP_CONTEXT(rel_5_new_ismarriedto_op_ctxt));
}
}
}
}
...
();}
if(rel_5_new_ismarriedto->empty()) break;
rel_3_ismarriedto->insertAll(*rel_5_new_ismarriedto);
std::swap(rel_4_delta_ismarriedto, rel_5_new_ismarriedto);
rel_5_new_ismarriedto->purge();
iter++;
}
iter = 0;
if (!isHintsProfilingEnabled()) rel_4_delta_ismarriedto->purge();
if (!isHintsProfilingEnabled()) rel_5_new_ismarriedto->purge();
if (performIO) {
...
/* BEGIN STRATUM 4 */
[&]() {
SignalHandler::instance()->setMsg(R"_(ismarriedto.@info.1(1,"v0,v1","Rule","actedin,v0,v2","ismarriedto,v1,v2","ismarriedto(v0,v1) :- 
   Rule(538),
   actedin(v0,v2),
   ismarriedto(v1,v2).").
in file  [0:0-0:0])_");
rel_7_ismarriedto_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3),RamDomain(4));
}();
/* END STRATUM 4 */
...
std::cout << "\n";
std::cout << "Relation rel_4_delta_ismarriedto:\n";
rel_4_delta_ismarriedto->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_5_new_ismarriedto:\n";
rel_5_new_ismarriedto->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_6_inv_0:\n";
rel_6_inv_0->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_7_ismarriedto_info_1:\n";
rel_7_ismarriedto_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
}
...
();[&](){
CREATE_OP_CONTEXT(rel_2_actedin_op_ctxt,rel_2_actedin->createContext());
if(!rel_2_actedin->equalRange_3(Tuple<RamDomain,4>({{(args)[0],(args)[2],0,0}}),READ_OP_CONTEXT(rel_2_actedin_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
...
std::mutex lock;
if(!(rel_3_ismarriedto->empty()) && !(rel_2_actedin->empty()) && !(rel_1_Rule->empty())) {
[&](){
const Tuple<RamDomain,3> key({{RamDomain(538),0,0}});
auto range = rel_1_Rule->equalRange_1(key);
auto part = range.partition();
...
auto range = rel_2_actedin->equalRange_1(key,READ_OP_CONTEXT(rel_2_actedin_op_ctxt));
