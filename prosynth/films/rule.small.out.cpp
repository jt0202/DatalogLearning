...
;// -- Table: actedin
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_1_actedin = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<0,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_1_actedin;
// -- Table: inv_0
...
public:
Sf_rule_small() : 
wrapper_rel_1_actedin(*rel_1_actedin,symTable,"actedin",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}),
...
addRelation("actedin",&wrapper_rel_1_actedin,false,true);
...
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_1_actedin);
...
std::cout << "Relation rel_1_actedin:\n";
rel_1_actedin->printHintStatistics(std::cout,"  ");
std::cout << "\n";
...
ioDirectives.setRelationName("rel_1_actedin");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_1_actedin);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
