...
// -- Table: produced
std::unique_ptr<t_btree_4__0_1_2_3__3__15> rel_2_produced = std::make_unique<t_btree_4__0_1_2_3__3__15>();
souffle::RelationWrapper<1,t_btree_4__0_1_2_3__3__15,Tuple<RamDomain,4>,4> wrapper_rel_2_produced;
// -- Table: actedin
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_3_actedin = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_actedin;
// -- Table: actedin.@info.1
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_4_actedin_info_1 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<3,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_4_actedin_info_1;
// -- Table: inv_0
...
wrapper_rel_2_produced(*rel_2_produced,symTable,"produced",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}),
...
wrapper_rel_4_actedin_info_1(*rel_4_actedin_info_1,symTable,"actedin.@info.1",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}),
...
addRelation("produced",&wrapper_rel_2_produced,true,false);
addRelation("actedin",&wrapper_rel_3_actedin,false,true);
addRelation("actedin.@info.1",&wrapper_rel_4_actedin_info_1,false,false);
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->readAll(*rel_2_produced);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
}();
/* END STRATUM 1 */
...
in file /home/johannes_tantow/DatalogLearning/prosynth/yagoresultsneg/rule.dl [53:1-53:48])_");
if(!(rel_2_produced->empty()) && !(rel_1_Rule->empty())) {
[&](){
const Tuple<RamDomain,3> key({{RamDomain(268),0,0}});
auto range = rel_1_Rule->equalRange_1(key);
auto part = range.partition();
PARALLEL_START;
CREATE_OP_CONTEXT(rel_2_produced_op_ctxt,rel_2_produced->createContext());
...
for(const auto& env1 : *rel_2_produced) {
...
rel_3_actedin->insert(tuple,READ_OP_CONTEXT(rel_3_actedin_op_ctxt));
}
}
...
SignalHandler::instance()->setMsg(R"_(actedin.@info.1(1,"v0,v1","Rule","produced,v0,v1","actedin(v0,v1) :- 
   ...
   produced(v0,v1).").
in file  [0:0-0:0])_");
rel_4_actedin_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3));
}();
/* END STRATUM 3 */
/* BEGIN STRATUM 4 */
[&]() {
...
std::cout << "\n";
std::cout << "Relation rel_2_produced:\n";
rel_2_produced->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_3_actedin:\n";
rel_3_actedin->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_4_actedin_info_1:\n";
rel_4_actedin_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_2_produced");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_2_produced);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
public:
...
();[&](){
CREATE_OP_CONTEXT(rel_2_produced_op_ctxt,rel_2_produced->createContext());
if(!rel_2_produced->equalRange_3(Tuple<RamDomain,4>({{(args)[0],(args)[1],0,0}}),READ_OP_CONTEXT(rel_2_produced_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
...
auto range = rel_2_produced->equalRange_3(key,READ_OP_CONTEXT(rel_2_produced_op_ctxt));
