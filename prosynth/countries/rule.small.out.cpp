...
// -- Table: imports
std::unique_ptr<t_btree_4__1_0_2_3__2__3__15> rel_3_imports = std::make_unique<t_btree_4__1_0_2_3__2__3__15>();
souffle::RelationWrapper<2,t_btree_4__1_0_2_3__2__3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_imports;
// -- Table: exports
...
in file /home/johannes_tantow/DatalogLearning/prosynth/countries/rule.dl [53:1-53:65])_");
if(!(rel_1_Iexports->empty()) && !(rel_3_imports->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
for(const auto& env1 : *rel_3_imports) {
...
/* BEGIN STRATUM 4 */
[&]() {
SignalHandler::instance()->setMsg(R"_(exports.@info.1(1,"v0,v1","Rule","imports,v2,v0","Iexports,v2,v1","exports(v0,v1) :- 
   Rule(465),
   imports(v2,v0),
   Iexports(v2,v1).").
in file  [0:0-0:0])_");
...
();[&](){
CREATE_OP_CONTEXT(rel_3_imports_op_ctxt,rel_3_imports->createContext());
if(!rel_3_imports->equalRange_3(Tuple<RamDomain,4>({{(args)[2],(args)[0],0,0}}),READ_OP_CONTEXT(rel_3_imports_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
...
auto range = rel_3_imports->equalRange_2(key,READ_OP_CONTEXT(rel_3_imports_op_ctxt));
