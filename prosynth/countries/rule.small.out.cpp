...
;// -- Table: exports
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_1_exports = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<0,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_1_exports;
// -- Table: inv_0
...
// -- Table: out
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_3_out = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_out;
public:
Sf_rule_small() : 
wrapper_rel_1_exports(*rel_1_exports,symTable,"exports",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}),
...
wrapper_rel_3_out(*rel_3_out,symTable,"out",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}){
addRelation("exports",&wrapper_rel_1_exports,false,true);
addRelation("inv_0",&wrapper_rel_2_inv_0,false,true);
addRelation("out",&wrapper_rel_3_out,false,true);
}
~Sf_rule_small() {
}
private:
...
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_1_exports);
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","v0\tv1"},{"filename","./out.csv"},{"name","out"}});
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_3_out);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
}();
/* END STRATUM 2 */
...
std::cout << "Relation rel_1_exports:\n";
rel_1_exports->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_2_inv_0:\n";
rel_2_inv_0->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_3_out:\n";
rel_3_out->printHintStatistics(std::cout,"  ");
std::cout << "\n";
}
...
ioDirectives.setRelationName("rel_1_exports");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_1_exports);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_3_out");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_3_out);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
public:
