...
// -- Table: imports
std::unique_ptr<t_btree_4__0_1_2_3__1__3__15> rel_3_imports = std::make_unique<t_btree_4__0_1_2_3__1__3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__1__3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_imports;
// -- Table: exports
...
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_5_exports_info_1 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<4,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_5_exports_info_1;
// -- Table: inv_0
...
wrapper_rel_5_exports_info_1(*rel_5_exports_info_1,symTable,"exports.@info.1",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}),
...
in file /home/johannes_tantow/DatalogLearning/prosynth/countries/rule.dl [53:1-53:66])_");
if(!(rel_3_imports->empty()) && !(rel_2_dealswith->empty()) && !(rel_1_Rule->empty())) {
[&](){
...
for(const auto& env1 : *rel_2_dealswith) {
const Tuple<RamDomain,4> key({{env1[1],0,0,0}});
auto range = rel_3_imports->equalRange_1(key,READ_OP_CONTEXT(rel_3_imports_op_ctxt));
...
/* BEGIN STRATUM 4 */
[&]() {
SignalHandler::instance()->setMsg(R"_(exports.@info.1(1,"v0,v1","Rule","dealswith,v0,v2","imports,v2,v1","exports(v0,v1) :- 
   Rule(311),
   dealswith(v0,v2),
   imports(v2,v1).").
in file  [0:0-0:0])_");
rel_5_exports_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3),RamDomain(4));
}();
/* END STRATUM 4 */
/* BEGIN STRATUM 5 */
[&]() {
...
();[&](){
CREATE_OP_CONTEXT(rel_3_imports_op_ctxt,rel_3_imports->createContext());
if(!rel_3_imports->equalRange_3(Tuple<RamDomain,4>({{(args)[2],(args)[1],0,0}}),READ_OP_CONTEXT(rel_3_imports_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
...
auto range = rel_2_dealswith->equalRange_1(key,READ_OP_CONTEXT(rel_2_dealswith_op_ctxt));
for(const auto& env1 : range) {
if( ((env1[3]) < ((args)[2]))) {
const Tuple<RamDomain,4> key({{env1[1],(args)[1],0,0}});
auto range = rel_3_imports->equalRange_3(key,READ_OP_CONTEXT(rel_3_imports_op_ctxt));
for(const auto& env2 : range) {
if( ((env2[3]) < ((args)[2]))) {
std::lock_guard<std::mutex> guard(lock);
ret.push_back(RamDomain(311));
