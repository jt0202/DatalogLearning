...
// -- Table: dealswith
std::unique_ptr<t_btree_4__0_1_2_3__1__3__15> rel_3_dealswith = std::make_unique<t_btree_4__0_1_2_3__1__3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__1__3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_dealswith;
// -- Table: exports
...
/* BEGIN STRATUM 4 */
[&]() {
SignalHandler::instance()->setMsg(R"_(exports.@info.1(1,"v0,v1","Rule","dealswith,v0,v2","Iexports,v2,v1","exports(v0,v1) :- 
   Rule(335),
   dealswith(v0,v2),
   Iexports(v2,v1).").
in file  [0:0-0:0])_");
