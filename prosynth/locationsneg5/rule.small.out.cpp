...
std::unique_ptr<t_btree_4__0_1_2_3__1__3__15> rel_1_Iwasbornin = std::make_unique<t_btree_4__0_1_2_3__1__3__15>();
souffle::RelationWrapper<0,t_btree_4__0_1_2_3__1__3__15,Tuple<RamDomain,4>,4> wrapper_rel_1_Iwasbornin;
// -- Table: Rule
...
// -- Table: livesin
std::unique_ptr<t_btree_4__1_0_2_3__2__3__15> rel_4_livesin = std::make_unique<t_btree_4__1_0_2_3__2__3__15>();
souffle::RelationWrapper<3,t_btree_4__1_0_2_3__2__3__15,Tuple<RamDomain,4>,4> wrapper_rel_4_livesin;
// -- Table: wasbornin
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_5_wasbornin = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<4,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_5_wasbornin;
// -- Table: wasbornin.@info.1
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_6_wasbornin_info_1 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<5,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_6_wasbornin_info_1;
public:
Sf_rule_small() : 
...
wrapper_rel_6_wasbornin_info_1(*rel_6_wasbornin_info_1,symTable,"wasbornin.@info.1",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}){
...
addRelation("livesin",&wrapper_rel_4_livesin,true,false);
addRelation("wasbornin",&wrapper_rel_5_wasbornin,false,true);
addRelation("wasbornin.@info.1",&wrapper_rel_6_wasbornin_info_1,false,false);
}
~Sf_rule_small() {
}
private:
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->readAll(*rel_4_livesin);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
}();
/* END STRATUM 3 */
...
in file /home/johannes/DatalogLearning/prosynth/locationsneg5/rule.dl [35:1-35:69])_");
if(!(rel_1_Iwasbornin->empty()) && !(rel_4_livesin->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
for(const auto& env1 : *rel_4_livesin) {
...
/* BEGIN STRATUM 5 */
[&]() {
SignalHandler::instance()->setMsg(R"_(wasbornin.@info.1(1,"v0,v1","Rule","livesin,v2,v1","Iwasbornin,v2,v0","wasbornin(v0,v1) :- 
   Rule(108),
   livesin(v2,v1),
   Iwasbornin(v2,v0).").
in file  [0:0-0:0])_");
rel_6_wasbornin_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3),RamDomain(4));
}();
/* END STRATUM 5 */
...
std::cout << "\n";
std::cout << "Relation rel_6_wasbornin_info_1:\n";
rel_6_wasbornin_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
}
...
();[&](){
CREATE_OP_CONTEXT(rel_4_livesin_op_ctxt,rel_4_livesin->createContext());
if(!rel_4_livesin->equalRange_3(Tuple<RamDomain,4>({{(args)[2],(args)[1],0,0}}),READ_OP_CONTEXT(rel_4_livesin_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
...
auto range = rel_4_livesin->equalRange_2(key,READ_OP_CONTEXT(rel_4_livesin_op_ctxt));
