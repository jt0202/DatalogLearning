...
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_12_wasbornin_info_4 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<9,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_12_wasbornin_info_4;
...
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_14_wasbornin_info_6 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<11,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_14_wasbornin_info_6;
public:
Sf_program_small() : 
...
wrapper_rel_12_wasbornin_info_4(*rel_12_wasbornin_info_4,symTable,"wasbornin.@info.4",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}),
...
wrapper_rel_14_wasbornin_info_6(*rel_14_wasbornin_info_6,symTable,"wasbornin.@info.6",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}){
...
in file /home/johannes/DatalogLearning/prosynth/locationsneg5/sol_wasbornin.dl [21:1-21:61])_");
...
in file /home/johannes/DatalogLearning/prosynth/locationsneg5/sol_wasbornin.dl [19:1-19:64])_");
...
for(const auto& env2 : range) {
Tuple<RamDomain,4> tuple({{static_cast<RamDomain>(env2[0]),static_cast<RamDomain>(env1[1]),static_cast<RamDomain>(RamDomain(2)),static_cast<RamDomain>((std::max({std::max({env0[2], env1[3], }), env2[3], })) + (RamDomain(1)))}});
...
in file /home/johannes/DatalogLearning/prosynth/locationsneg5/sol_wasbornin.dl [22:1-22:48])_");
...
in file /home/johannes/DatalogLearning/prosynth/locationsneg5/sol_wasbornin.dl [23:1-23:69])_");
...
for(const auto& env2 : range) {
Tuple<RamDomain,4> tuple({{static_cast<RamDomain>(env2[0]),static_cast<RamDomain>(env1[0]),static_cast<RamDomain>(RamDomain(5)),static_cast<RamDomain>((std::max({std::max({env0[2], env1[3], }), env2[3], })) + (RamDomain(1)))}});
rel_5_wasbornin->insert(tuple,READ_OP_CONTEXT(rel_5_wasbornin_op_ctxt));
}
}
}
...
();}
SignalHandler::instance()->setMsg(R"_(wasbornin(v0,v1,6,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   Rule(108,_,@level_num_0),
   livesin(v2,v1,_,@level_num_1),
   Iwasbornin(v2,v0,_,@level_num_2).
in file /home/johannes/DatalogLearning/prosynth/locationsneg5/sol_wasbornin.dl [24:1-24:69])_");
if(!(rel_1_Iwasbornin->empty()) && !(rel_3_livesin->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
in file /home/johannes/DatalogLearning/prosynth/locationsneg5/sol_wasbornin.dl [18:1-18:68])_");
...
in file /home/johannes/DatalogLearning/prosynth/locationsneg5/sol_wasbornin.dl [20:1-20:68])_");
if(!(rel_6_delta_wasbornin->empty()) && !(rel_3_livesin->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
/* BEGIN STRATUM 7 */
[&]() {
SignalHandler::instance()->setMsg(R"_(wasbornin.@info.2(2,"v0,v1","Rule","livesin,v2,v1","inv_0,v0,v2","wasbornin(v0,v1) :- 
   Rule(114),
   livesin(v2,v1),
   inv_0(v0,v2).").
in file  [0:0-0:0])_");
rel_10_wasbornin_info_2->insert(RamDomain(2),RamDomain(0),RamDomain(1),RamDomain(7),RamDomain(8),RamDomain(9));
}();
/* END STRATUM 7 */
/* BEGIN STRATUM 8 */
[&]() {
SignalHandler::instance()->setMsg(R"_(wasbornin.@info.3(3,"v0,v1","Rule","livesin,v2,v1","wasbornin,v0,v2","wasbornin(v0,v1) :- 
   Rule(126),
   livesin(v2,v1),
   wasbornin(v0,v2).").
in file  [0:0-0:0])_");
rel_11_wasbornin_info_3->insert(RamDomain(3),RamDomain(0),RamDomain(1),RamDomain(7),RamDomain(10),RamDomain(11));
}();
/* END STRATUM 8 */
/* BEGIN STRATUM 9 */
[&]() {
SignalHandler::instance()->setMsg(R"_(wasbornin.@info.4(4,"v0,v1","Rule","livesin,v0,v1","wasbornin(v0,v1) :- 
   Rule(78),
   livesin(v0,v1).").
in file  [0:0-0:0])_");
rel_12_wasbornin_info_4->insert(RamDomain(4),RamDomain(0),RamDomain(1),RamDomain(12),RamDomain(13));
}();
/* END STRATUM 9 */
/* BEGIN STRATUM 10 */
[&]() {
SignalHandler::instance()->setMsg(R"_(wasbornin.@info.5(5,"v0,v1","Rule","livesin,v1,v2","Iwasbornin,v0,v2","wasbornin(v0,v1) :- 
   Rule(109),
   livesin(v1,v2),
   Iwasbornin(v0,v2).").
in file  [0:0-0:0])_");
rel_13_wasbornin_info_5->insert(RamDomain(5),RamDomain(0),RamDomain(1),RamDomain(3),RamDomain(14),RamDomain(15));
}();
/* END STRATUM 10 */
/* BEGIN STRATUM 11 */
[&]() {
SignalHandler::instance()->setMsg(R"_(wasbornin.@info.6(6,"v0,v1","Rule","livesin,v2,v1","Iwasbornin,v2,v0","wasbornin(v0,v1) :- 
   Rule(108),
   livesin(v2,v1),
   Iwasbornin(v2,v0).").
in file  [0:0-0:0])_");
rel_14_wasbornin_info_6->insert(RamDomain(6),RamDomain(0),RamDomain(1),RamDomain(7),RamDomain(16),RamDomain(17));
}();
/* END STRATUM 11 */
