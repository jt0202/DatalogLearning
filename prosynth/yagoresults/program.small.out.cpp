...
// -- Table: inv_0
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_3_inv_0 = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_inv_0;
// -- Table: wasbornin
std::unique_ptr<t_btree_4__0_1_3_2__1_0_2_3__1__2__3__15> rel_4_wasbornin = std::make_unique<t_btree_4__0_1_3_2__1_0_2_3__1__2__3__15>();
souffle::RelationWrapper<3,t_btree_4__0_1_3_2__1_0_2_3__1__2__3__15,Tuple<RamDomain,4>,4> wrapper_rel_4_wasbornin;
// -- Table: livesin
std::unique_ptr<t_btree_4__0_1_2_3__3__15> rel_5_livesin = std::make_unique<t_btree_4__0_1_2_3__3__15>();
souffle::RelationWrapper<4,t_btree_4__0_1_2_3__3__15,Tuple<RamDomain,4>,4> wrapper_rel_5_livesin;
// -- Table: @delta_livesin
std::unique_ptr<t_btree_4__1_0_2_3__2__15> rel_6_delta_livesin = std::make_unique<t_btree_4__1_0_2_3__2__15>();
// -- Table: @new_livesin
std::unique_ptr<t_btree_4__1_0_2_3__2__15> rel_7_new_livesin = std::make_unique<t_btree_4__1_0_2_3__2__15>();
// -- Table: livesin.@info.1
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_8_livesin_info_1 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<5,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_8_livesin_info_1;
// -- Table: livesin.@info.2
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_9_livesin_info_2 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<6,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_9_livesin_info_2;
// -- Table: livesin.@info.3
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_10_livesin_info_3 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<7,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_10_livesin_info_3;
// -- Table: livesin.@info.4
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_11_livesin_info_4 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<8,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_11_livesin_info_4;
// -- Table: livesin.@info.5
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_12_livesin_info_5 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<9,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_12_livesin_info_5;
public:
Sf_program_small() : 
...
wrapper_rel_3_inv_0(*rel_3_inv_0,symTable,"inv_0",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}),

wrapper_rel_4_wasbornin(*rel_4_wasbornin,symTable,"wasbornin",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}),
...
wrapper_rel_8_livesin_info_1(*rel_8_livesin_info_1,symTable,"livesin.@info.1",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}),

wrapper_rel_9_livesin_info_2(*rel_9_livesin_info_2,symTable,"livesin.@info.2",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}),

wrapper_rel_10_livesin_info_3(*rel_10_livesin_info_3,symTable,"livesin.@info.3",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}),

wrapper_rel_11_livesin_info_4(*rel_11_livesin_info_4,symTable,"livesin.@info.4",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}),

wrapper_rel_12_livesin_info_5(*rel_12_livesin_info_5,symTable,"livesin.@info.5",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}){
addRelation("Ilivesin",&wrapper_rel_1_Ilivesin,true,false);
addRelation("Rule",&wrapper_rel_2_Rule,true,false);
addRelation("inv_0",&wrapper_rel_3_inv_0,false,true);
addRelation("wasbornin",&wrapper_rel_4_wasbornin,true,false);
addRelation("livesin",&wrapper_rel_5_livesin,false,true);
addRelation("livesin.@info.1",&wrapper_rel_8_livesin_info_1,false,false);
addRelation("livesin.@info.2",&wrapper_rel_9_livesin_info_2,false,false);
addRelation("livesin.@info.3",&wrapper_rel_10_livesin_info_3,false,false);
addRelation("livesin.@info.4",&wrapper_rel_11_livesin_info_4,false,false);
addRelation("livesin.@info.5",&wrapper_rel_12_livesin_info_5,false,false);
}
~Sf_program_small() {
}
private:
...
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_3_inv_0);
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->readAll(*rel_4_wasbornin);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
}();
/* END STRATUM 3 */
...
in file /home/johannes_tantow/DatalogLearning/prosynth/yagoresults/sol_livesin.dl [18:1-18:67])_");
if(!(rel_1_Ilivesin->empty()) && !(rel_4_wasbornin->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
CREATE_OP_CONTEXT(rel_4_wasbornin_op_ctxt,rel_4_wasbornin->createContext());
CREATE_OP_CONTEXT(rel_5_livesin_op_ctxt,rel_5_livesin->createContext());
pfor(auto it = part.begin(); it<part.end(); ++it) { 
try{
for(const auto& env0 : *it) {
for(const auto& env1 : *rel_4_wasbornin) {
...
Tuple<RamDomain,4> tuple({{static_cast<RamDomain>(env2[0]),static_cast<RamDomain>(env1[0]),static_cast<RamDomain>(RamDomain(1)),static_cast<RamDomain>((std::max({std::max({env0[2], env1[3], }), env2[3], })) + (RamDomain(1)))}});
...
in file /home/johannes_tantow/DatalogLearning/prosynth/yagoresults/sol_livesin.dl [19:1-19:48])_");
if(!(rel_4_wasbornin->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
();}
SignalHandler::instance()->setMsg(R"_(livesin(v0,v1,4,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   Rule(108,_,@level_num_0),
   wasbornin(v2,v1,_,@level_num_1),
   Ilivesin(v2,v0,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/yagoresults/sol_livesin.dl [21:1-21:67])_");
if(!(rel_1_Ilivesin->empty()) && !(rel_4_wasbornin->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
iter = 0;
for(;;) {
SignalHandler::instance()->setMsg(R"_(livesin(v0,v1,3,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   Rule(126,_,@level_num_0),
   wasbornin(v2,v1,_,@level_num_1),
   livesin(v0,v2,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/yagoresults/sol_livesin.dl [20:1-20:66])_");
if(!(rel_6_delta_livesin->empty()) && !(rel_4_wasbornin->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
for(const auto& env2 : range) {
if( !([&]() -> bool {
auto existenceCheck = rel_5_livesin->equalRange_3(Tuple<RamDomain,4>({{env2[0],env1[1],0,0}}),READ_OP_CONTEXT(rel_5_livesin_op_ctxt));
...
();}
SignalHandler::instance()->setMsg(R"_(livesin(v0,v1,5,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   Rule(130,_,@level_num_0),
   wasbornin(v0,v2,_,@level_num_1),
   livesin(v1,v2,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/yagoresults/sol_livesin.dl [22:1-22:66])_");
if(!(rel_6_delta_livesin->empty()) && !(rel_4_wasbornin->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
for(const auto& env2 : range) {
if( !([&]() -> bool {
auto existenceCheck = rel_5_livesin->equalRange_3(Tuple<RamDomain,4>({{env1[0],env2[0],0,0}}),READ_OP_CONTEXT(rel_5_livesin_op_ctxt));
if (existenceCheck.empty()) return false; else return (*existenceCheck.begin())[3] <= (std::max({std::max({env0[2], env1[3], }), env2[3], })) + (RamDomain(1));}()
)) {
...
/* BEGIN STRATUM 5 */
[&]() {
SignalHandler::instance()->setMsg(R"_(livesin.@info.1(1,"v0,v1","Rule","wasbornin,v1,v2","Ilivesin,v0,v2","livesin(v0,v1) :- 
   Rule(109),
   wasbornin(v1,v2),
   Ilivesin(v0,v2).").
in file  [0:0-0:0])_");
rel_8_livesin_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3),RamDomain(4));
}();
/* END STRATUM 5 */
/* BEGIN STRATUM 6 */
[&]() {
SignalHandler::instance()->setMsg(R"_(livesin.@info.2(2,"v0,v1","Rule","wasbornin,v0,v1","livesin(v0,v1) :- 
   Rule(78),
   wasbornin(v0,v1).").
in file  [0:0-0:0])_");
rel_9_livesin_info_2->insert(RamDomain(2),RamDomain(0),RamDomain(1),RamDomain(5),RamDomain(6));
}();
/* END STRATUM 6 */
/* BEGIN STRATUM 7 */
[&]() {
SignalHandler::instance()->setMsg(R"_(livesin.@info.3(3,"v0,v1","Rule","wasbornin,v2,v1","livesin,v0,v2","livesin(v0,v1) :- 
   Rule(126),
   wasbornin(v2,v1),
   livesin(v0,v2).").
in file  [0:0-0:0])_");
rel_10_livesin_info_3->insert(RamDomain(3),RamDomain(0),RamDomain(1),RamDomain(7),RamDomain(8),RamDomain(9));
}();
/* END STRATUM 7 */
/* BEGIN STRATUM 8 */
[&]() {
SignalHandler::instance()->setMsg(R"_(livesin.@info.4(4,"v0,v1","Rule","wasbornin,v2,v1","Ilivesin,v2,v0","livesin(v0,v1) :- 
   Rule(108),
   wasbornin(v2,v1),
   Ilivesin(v2,v0).").
in file  [0:0-0:0])_");
rel_11_livesin_info_4->insert(RamDomain(4),RamDomain(0),RamDomain(1),RamDomain(7),RamDomain(10),RamDomain(11));
}();
/* END STRATUM 8 */
/* BEGIN STRATUM 9 */
[&]() {
SignalHandler::instance()->setMsg(R"_(livesin.@info.5(5,"v0,v1","Rule","wasbornin,v0,v2","livesin,v1,v2","livesin(v0,v1) :- 
   Rule(130),
   wasbornin(v0,v2),
   livesin(v1,v2).").
in file  [0:0-0:0])_");
rel_12_livesin_info_5->insert(RamDomain(5),RamDomain(0),RamDomain(1),RamDomain(12),RamDomain(13),RamDomain(14));
}();
/* END STRATUM 9 */
...
std::cout << "\n";
std::cout << "Relation rel_3_inv_0:\n";
rel_3_inv_0->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_4_wasbornin:\n";
rel_4_wasbornin->printHintStatistics(std::cout,"  ");
std::cout << "\n";
...
std::cout << "\n";
std::cout << "Relation rel_9_livesin_info_2:\n";
rel_9_livesin_info_2->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_10_livesin_info_3:\n";
rel_10_livesin_info_3->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_11_livesin_info_4:\n";
rel_11_livesin_info_4->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_12_livesin_info_5:\n";
rel_12_livesin_info_5->printHintStatistics(std::cout,"  ");
std::cout << "\n";
}
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_4_wasbornin");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_4_wasbornin);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
public:
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_3_inv_0");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_3_inv_0);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
...
();[&](){
CREATE_OP_CONTEXT(rel_4_wasbornin_op_ctxt,rel_4_wasbornin->createContext());
if(!rel_4_wasbornin->equalRange_3(Tuple<RamDomain,4>({{(args)[1],(args)[2],0,0}}),READ_OP_CONTEXT(rel_4_wasbornin_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
...
auto range = rel_4_wasbornin->equalRange_1(key,READ_OP_CONTEXT(rel_4_wasbornin_op_ctxt));
...
();[&](){
CREATE_OP_CONTEXT(rel_4_wasbornin_op_ctxt,rel_4_wasbornin->createContext());
if(!rel_4_wasbornin->equalRange_3(Tuple<RamDomain,4>({{(args)[0],(args)[1],0,0}}),READ_OP_CONTEXT(rel_4_wasbornin_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
ret.push_back(RamDomain(1));
err.push_back(false);
}
...
auto range = rel_4_wasbornin->equalRange_3(key,READ_OP_CONTEXT(rel_4_wasbornin_op_ctxt));
for(const auto& env1 : range) {
if( ((env1[3]) < ((args)[2]))) {
std::lock_guard<std::mutex> guard(lock);
ret.push_back(RamDomain(78));
...
();[&](){
CREATE_OP_CONTEXT(rel_4_wasbornin_op_ctxt,rel_4_wasbornin->createContext());
if(!rel_4_wasbornin->equalRange_3(Tuple<RamDomain,4>({{(args)[2],(args)[1],0,0}}),READ_OP_CONTEXT(rel_4_wasbornin_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
ret.push_back(RamDomain(1));
err.push_back(false);
}
...
();[&](){
CREATE_OP_CONTEXT(rel_5_livesin_op_ctxt,rel_5_livesin->createContext());
if(!rel_5_livesin->equalRange_3(Tuple<RamDomain,4>({{(args)[0],(args)[2],0,0}}),READ_OP_CONTEXT(rel_5_livesin_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
ret.push_back(RamDomain(2));
err.push_back(false);
}
...
std::mutex lock;
if(!(rel_5_livesin->empty()) && !(rel_4_wasbornin->empty()) && !(rel_2_Rule->empty())) {
[&](){
const Tuple<RamDomain,3> key({{RamDomain(126),0,0}});
auto range = rel_2_Rule->equalRange_1(key);
auto part = range.partition();
...
auto range = rel_4_wasbornin->equalRange_2(key,READ_OP_CONTEXT(rel_4_wasbornin_op_ctxt));
for(const auto& env1 : range) {
if( ((env1[3]) < ((args)[2]))) {
...
();[&](){
CREATE_OP_CONTEXT(rel_4_wasbornin_op_ctxt,rel_4_wasbornin->createContext());
if(!rel_4_wasbornin->equalRange_3(Tuple<RamDomain,4>({{(args)[0],(args)[2],0,0}}),READ_OP_CONTEXT(rel_4_wasbornin_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
ret.push_back(RamDomain(1));
err.push_back(false);
}
...
{
try{
souffle::CmdOptions opt(R"(sol_livesin.dl)",
R"(.)",
R"(.)",
false,
R"()",
