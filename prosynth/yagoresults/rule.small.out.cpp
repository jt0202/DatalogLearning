...
// -- Table: exports
std::unique_ptr<t_btree_4__0_1_2_3__1__3__15> rel_2_exports = std::make_unique<t_btree_4__0_1_2_3__1__3__15>();
souffle::RelationWrapper<1,t_btree_4__0_1_2_3__1__3__15,Tuple<RamDomain,4>,4> wrapper_rel_2_exports;
// -- Table: dealswith
std::unique_ptr<t_btree_4__0_1_2_3__3__15> rel_3_dealswith = std::make_unique<t_btree_4__0_1_2_3__3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_dealswith;
// -- Table: @delta_dealswith
std::unique_ptr<t_btree_4__1_0_2_3__2__15> rel_4_delta_dealswith = std::make_unique<t_btree_4__1_0_2_3__2__15>();
// -- Table: @new_dealswith
std::unique_ptr<t_btree_4__1_0_2_3__2__15> rel_5_new_dealswith = std::make_unique<t_btree_4__1_0_2_3__2__15>();
// -- Table: dealswith.@info.1
std::unique_ptr<t_btree_6__0_1_2_3_4_5__63> rel_6_dealswith_info_1 = std::make_unique<t_btree_6__0_1_2_3_4_5__63>();
souffle::RelationWrapper<3,t_btree_6__0_1_2_3_4_5__63,Tuple<RamDomain,6>,6> wrapper_rel_6_dealswith_info_1;
// -- Table: inv_0
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_7_inv_0 = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<4,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_7_inv_0;
public:
Sf_rule_small() : 
...
wrapper_rel_2_exports(*rel_2_exports,symTable,"exports",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}),
...
wrapper_rel_6_dealswith_info_1(*rel_6_dealswith_info_1,symTable,"dealswith.@info.1",std::array<const char *,6>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,6>{{"clause_num","head_vars","rel_0","rel_1","rel_2","clause_repr"}}),
...
addRelation("exports",&wrapper_rel_2_exports,true,false);
addRelation("dealswith",&wrapper_rel_3_dealswith,false,true);
addRelation("dealswith.@info.1",&wrapper_rel_6_dealswith_info_1,false,false);
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->readAll(*rel_2_exports);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
}();
/* END STRATUM 1 */
/* BEGIN STRATUM 2 */
[&]() {
rel_4_delta_dealswith->insertAll(*rel_3_dealswith);
iter = 0;
for(;;) {
...
in file /home/johannes_tantow/DatalogLearning/prosynth/yagoresults/rule.dl [53:1-53:68])_");
if(!(rel_4_delta_dealswith->empty()) && !(rel_2_exports->empty()) && !(rel_1_Rule->empty())) {
[&](){
...
CREATE_OP_CONTEXT(rel_2_exports_op_ctxt,rel_2_exports->createContext());
CREATE_OP_CONTEXT(rel_3_dealswith_op_ctxt,rel_3_dealswith->createContext());
CREATE_OP_CONTEXT(rel_4_delta_dealswith_op_ctxt,rel_4_delta_dealswith->createContext());
CREATE_OP_CONTEXT(rel_5_new_dealswith_op_ctxt,rel_5_new_dealswith->createContext());
pfor(auto it = part.begin(); it<part.end(); ++it) { 
try{
for(const auto& env0 : *it) {
for(const auto& env1 : *rel_2_exports) {
const Tuple<RamDomain,4> key({{0,env1[1],0,0}});
auto range = rel_4_delta_dealswith->equalRange_2(key,READ_OP_CONTEXT(rel_4_delta_dealswith_op_ctxt));
for(const auto& env2 : range) {
if( !([&]() -> bool {
auto existenceCheck = rel_3_dealswith->equalRange_3(Tuple<RamDomain,4>({{env1[0],env2[0],0,0}}),READ_OP_CONTEXT(rel_3_dealswith_op_ctxt));
...
rel_5_new_dealswith->insert(tuple,READ_OP_CONTEXT(rel_5_new_dealswith_op_ctxt));
}
}
}
}
...
();}
if(rel_5_new_dealswith->empty()) break;
rel_3_dealswith->insertAll(*rel_5_new_dealswith);
std::swap(rel_4_delta_dealswith, rel_5_new_dealswith);
rel_5_new_dealswith->purge();
iter++;
}
iter = 0;
if (!isHintsProfilingEnabled()) rel_4_delta_dealswith->purge();
if (!isHintsProfilingEnabled()) rel_5_new_dealswith->purge();
if (performIO) {
...
/* BEGIN STRATUM 3 */
[&]() {
SignalHandler::instance()->setMsg(R"_(dealswith.@info.1(1,"v0,v1","Rule","exports,v0,v2","dealswith,v1,v2","dealswith(v0,v1) :- 
   Rule(538),
   exports(v0,v2),
   dealswith(v1,v2).").
in file  [0:0-0:0])_");
rel_6_dealswith_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3),RamDomain(4));
}();
/* END STRATUM 3 */
/* BEGIN STRATUM 4 */
[&]() {
...
std::cout << "\n";
std::cout << "Relation rel_2_exports:\n";
rel_2_exports->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_3_dealswith:\n";
rel_3_dealswith->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_4_delta_dealswith:\n";
rel_4_delta_dealswith->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_5_new_dealswith:\n";
rel_5_new_dealswith->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_6_dealswith_info_1:\n";
rel_6_dealswith_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_2_exports");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_2_exports);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
public:
...
();[&](){
CREATE_OP_CONTEXT(rel_2_exports_op_ctxt,rel_2_exports->createContext());
if(!rel_2_exports->equalRange_3(Tuple<RamDomain,4>({{(args)[0],(args)[2],0,0}}),READ_OP_CONTEXT(rel_2_exports_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
...
std::mutex lock;
if(!(rel_3_dealswith->empty()) && !(rel_2_exports->empty()) && !(rel_1_Rule->empty())) {
[&](){
const Tuple<RamDomain,3> key({{RamDomain(538),0,0}});
auto range = rel_1_Rule->equalRange_1(key);
auto part = range.partition();
...
auto range = rel_2_exports->equalRange_1(key,READ_OP_CONTEXT(rel_2_exports_op_ctxt));
