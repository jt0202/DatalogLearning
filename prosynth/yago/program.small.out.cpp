...
// -- Table: ismarriedto
std::unique_ptr<t_btree_4__0_1_2_3__3__15> rel_2_ismarriedto = std::make_unique<t_btree_4__0_1_2_3__3__15>();
souffle::RelationWrapper<1,t_btree_4__0_1_2_3__3__15,Tuple<RamDomain,4>,4> wrapper_rel_2_ismarriedto;
// -- Table: influences
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_3_influences = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_influences;
// -- Table: influences.@info.1
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_4_influences_info_1 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<3,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_4_influences_info_1;
// -- Table: inv_0
...
wrapper_rel_3_influences(*rel_3_influences,symTable,"influences",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}),

wrapper_rel_4_influences_info_1(*rel_4_influences_info_1,symTable,"influences.@info.1",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}),
...
addRelation("influences",&wrapper_rel_3_influences,false,true);
addRelation("influences.@info.1",&wrapper_rel_4_influences_info_1,false,false);
...
/* BEGIN STRATUM 2 */
[&]() {
SignalHandler::instance()->setMsg(R"_(influences(v0,v1,1,(max(@level_num_0,@level_num_1)+1)) :- 
   Rule(30,_,@level_num_0),
   ismarriedto(v0,v1,_,@level_num_1).
in file /home/johannes_tantow/DatalogLearning/prosynth/yago/solution.dl [48:1-48:53])_");
if(!(rel_2_ismarriedto->empty()) && !(rel_1_Rule->empty())) {
[&](){
const Tuple<RamDomain,3> key({{RamDomain(30),0,0}});
auto range = rel_1_Rule->equalRange_1(key);
auto part = range.partition();
PARALLEL_START;
CREATE_OP_CONTEXT(rel_3_influences_op_ctxt,rel_3_influences->createContext());
...
rel_3_influences->insert(tuple,READ_OP_CONTEXT(rel_3_influences_op_ctxt));
}
}
...
();}
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","v0\tv1"},{"filename","./influences.csv"},{"name","influences"}});
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_3_influences);
...
/* BEGIN STRATUM 3 */
[&]() {
SignalHandler::instance()->setMsg(R"_(influences.@info.1(1,"v0,v1","Rule","ismarriedto,v0,v1","influences(v0,v1) :- 
   Rule(30),
   ismarriedto(v0,v1).").
in file  [0:0-0:0])_");
rel_4_influences_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3));
}();
/* END STRATUM 3 */
/* BEGIN STRATUM 4 */
[&]() {
...
std::cout << "\n";
std::cout << "Relation rel_3_influences:\n";
rel_3_influences->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_4_influences_info_1:\n";
rel_4_influences_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_3_influences");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_3_influences);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
...
if (name == "influences_1_negation_subproof") {
subproof_0(args, ret, err);
}
if (name == "influences_1_subproof") {
...
();[&](){
CREATE_OP_CONTEXT(rel_2_ismarriedto_op_ctxt,rel_2_ismarriedto->createContext());
if(!rel_2_ismarriedto->equalRange_3(Tuple<RamDomain,4>({{(args)[0],(args)[1],0,0}}),READ_OP_CONTEXT(rel_2_ismarriedto_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
