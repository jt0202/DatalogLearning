...
// -- Table: exports
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_3_exports = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_exports;
// -- Table: exports.@info.1
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_4_exports_info_1 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<3,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_4_exports_info_1;
// -- Table: inv_0
...
wrapper_rel_4_exports_info_1(*rel_4_exports_info_1,symTable,"exports.@info.1",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}),
...
addRelation("exports",&wrapper_rel_3_exports,false,true);
addRelation("exports.@info.1",&wrapper_rel_4_exports_info_1,false,false);
...
/* BEGIN STRATUM 2 */
[&]() {
SignalHandler::instance()->setMsg(R"_(exports(v0,v1,1,(max(@level_num_0,@level_num_1)+1)) :- 
   dealswith(v0,v2,_,@level_num_0),
   Iexports(v2,v1,_,@level_num_1).
in file /home/johannes/DatalogLearning/prosynth/countriesAMIE/rule.dl [53:1-53:56])_");
...
Tuple<RamDomain,4> tuple({{static_cast<RamDomain>(env0[0]),static_cast<RamDomain>(env1[1]),static_cast<RamDomain>(RamDomain(1)),static_cast<RamDomain>((std::max({env0[3], env1[3], })) + (RamDomain(1)))}});
rel_3_exports->insert(tuple,READ_OP_CONTEXT(rel_3_exports_op_ctxt));
}
}
...
/* BEGIN STRATUM 3 */
[&]() {
SignalHandler::instance()->setMsg(R"_(exports.@info.1(1,"v0,v1","dealswith,v0,v2","Iexports,v2,v1","exports(v0,v1) :- 
   dealswith(v0,v2),
   Iexports(v2,v1).").
in file  [0:0-0:0])_");
rel_4_exports_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3));
}();
/* END STRATUM 3 */
/* BEGIN STRATUM 4 */
[&]() {
...
std::cout << "\n";
std::cout << "Relation rel_4_exports_info_1:\n";
rel_4_exports_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
