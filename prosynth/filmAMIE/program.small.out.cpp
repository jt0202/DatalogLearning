...
// -- Table: directed
std::unique_ptr<t_btree_4__0_1_2_3__3__15> rel_2_directed = std::make_unique<t_btree_4__0_1_2_3__3__15>();
souffle::RelationWrapper<1,t_btree_4__0_1_2_3__3__15,Tuple<RamDomain,4>,4> wrapper_rel_2_directed;
// -- Table: created
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_3_created = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_created;
// -- Table: created.@info.1
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_4_created_info_1 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<3,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_4_created_info_1;
// -- Table: inv_0
...
wrapper_rel_2_directed(*rel_2_directed,symTable,"directed",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}),
...
wrapper_rel_4_created_info_1(*rel_4_created_info_1,symTable,"created.@info.1",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}),
...
addRelation("directed",&wrapper_rel_2_directed,true,false);
addRelation("created",&wrapper_rel_3_created,false,true);
addRelation("created.@info.1",&wrapper_rel_4_created_info_1,false,false);
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->readAll(*rel_2_directed);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
}();
/* END STRATUM 1 */
/* BEGIN STRATUM 2 */
[&]() {
SignalHandler::instance()->setMsg(R"_(created(v0,v1,1,(max(@level_num_0,@level_num_1)+1)) :- 
   Rule(266,_,@level_num_0),
   directed(v0,v1,_,@level_num_1).
in file /home/johannes/DatalogLearning/prosynth/filmAMIE/sol_created.dl [27:1-27:48])_");
if(!(rel_2_directed->empty()) && !(rel_1_Rule->empty())) {
[&](){
const Tuple<RamDomain,3> key({{RamDomain(266),0,0}});
auto range = rel_1_Rule->equalRange_1(key);
auto part = range.partition();
PARALLEL_START;
CREATE_OP_CONTEXT(rel_2_directed_op_ctxt,rel_2_directed->createContext());
...
for(const auto& env1 : *rel_2_directed) {
...
rel_3_created->insert(tuple,READ_OP_CONTEXT(rel_3_created_op_ctxt));
}
}
...
/* BEGIN STRATUM 3 */
[&]() {
SignalHandler::instance()->setMsg(R"_(created.@info.1(1,"v0,v1","Rule","directed,v0,v1","created(v0,v1) :- 
   Rule(266),
   directed(v0,v1).").
in file  [0:0-0:0])_");
rel_4_created_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3));
}();
/* END STRATUM 3 */
/* BEGIN STRATUM 4 */
[&]() {
...
std::cout << "\n";
std::cout << "Relation rel_2_directed:\n";
rel_2_directed->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_3_created:\n";
rel_3_created->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_4_created_info_1:\n";
rel_4_created_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_2_directed");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_2_directed);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
public:
...
();[&](){
CREATE_OP_CONTEXT(rel_2_directed_op_ctxt,rel_2_directed->createContext());
if(!rel_2_directed->equalRange_3(Tuple<RamDomain,4>({{(args)[0],(args)[1],0,0}}),READ_OP_CONTEXT(rel_2_directed_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
...
auto range = rel_2_directed->equalRange_3(key,READ_OP_CONTEXT(rel_2_directed_op_ctxt));
