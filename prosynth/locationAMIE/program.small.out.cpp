...
// -- Table: livesin
std::unique_ptr<t_btree_4__0_1_2_3__3__15> rel_3_livesin = std::make_unique<t_btree_4__0_1_2_3__3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_livesin;
// -- Table: wasbornin
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_4_wasbornin = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<3,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_4_wasbornin;
// -- Table: wasbornin.@info.1
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_5_wasbornin_info_1 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<4,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_5_wasbornin_info_1;
public:
Sf_program_small() : 
...
wrapper_rel_5_wasbornin_info_1(*rel_5_wasbornin_info_1,symTable,"wasbornin.@info.1",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}){
...
addRelation("wasbornin",&wrapper_rel_4_wasbornin,false,true);
addRelation("wasbornin.@info.1",&wrapper_rel_5_wasbornin_info_1,false,false);
}
~Sf_program_small() {
}
private:
...
in file /home/johannes/DatalogLearning/prosynth/locationAMIE/sol_wasbornin.dl [18:1-18:48])_");
if(!(rel_3_livesin->empty()) && !(rel_1_Rule->empty())) {
[&](){
...
rel_4_wasbornin->insert(tuple,READ_OP_CONTEXT(rel_4_wasbornin_op_ctxt));
}
}
...
SignalHandler::instance()->setMsg(R"_(wasbornin.@info.1(1,"v0,v1","Rule","livesin,v0,v1","wasbornin(v0,v1) :- 
   ...
   livesin(v0,v1).").
in file  [0:0-0:0])_");
rel_5_wasbornin_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3));
}();
/* END STRATUM 4 */
...
std::cout << "\n";
std::cout << "Relation rel_5_wasbornin_info_1:\n";
rel_5_wasbornin_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
}
