...
in file /home/johannes/DatalogLearning/prosynth/countrieso/rule.dl [53:1-53:65])_");
...
/* BEGIN STRATUM 4 */
[&]() {
SignalHandler::instance()->setMsg(R"_(exports.@info.1(1,"v0,v1","Rule","imports,v2,v1","Iexports,v2,v0","exports(v0,v1) :- 
   Rule(468),
   imports(v2,v1),
   Iexports(v2,v0).").
in file  [0:0-0:0])_");
