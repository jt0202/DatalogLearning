...
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_7_haschild_info_1 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<4,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_7_haschild_info_1;
...
wrapper_rel_7_haschild_info_1(*rel_7_haschild_info_1,symTable,"haschild.@info.1",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}),
...
in file /home/johannes_tantow/DatalogLearning/prosynth/family/sol_haschild.dl [18:1-18:51])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/family/sol_haschild.dl [21:1-21:72])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/family/sol_haschild.dl [22:1-22:71])_");
...
SignalHandler::instance()->setMsg(R"_(haschild(v0,v1,7,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   Ihaschild(v2,v0,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/family/sol_haschild.dl [24:1-24:71])_");
if(!(rel_1_Ihaschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
in file /home/johannes_tantow/DatalogLearning/prosynth/family/sol_haschild.dl [25:1-25:71])_");
if(!(rel_1_Ihaschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
in file /home/johannes_tantow/DatalogLearning/prosynth/family/sol_haschild.dl [26:1-26:71])_");
if(!(rel_1_Ihaschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
for(const auto& env2 : range) {
Tuple<RamDomain,4> tuple({{static_cast<RamDomain>(env1[1]),static_cast<RamDomain>(env2[0]),static_cast<RamDomain>(RamDomain(9)),static_cast<RamDomain>((std::max({std::max({env0[2], env1[3], }), env2[3], })) + (RamDomain(1)))}});
rel_4_haschild->insert(tuple,READ_OP_CONTEXT(rel_4_haschild_op_ctxt));
}
}
}
...
in file /home/johannes_tantow/DatalogLearning/prosynth/family/sol_haschild.dl [19:1-19:70])_");
...
in file /home/johannes_tantow/DatalogLearning/prosynth/family/sol_haschild.dl [20:1-20:70])_");
if(!(rel_5_delta_haschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
Tuple<RamDomain,4> tuple({{static_cast<RamDomain>(env2[1]),static_cast<RamDomain>(env1[0]),static_cast<RamDomain>(RamDomain(3)),static_cast<RamDomain>((std::max({std::max({env0[2], env1[3], }), env2[3], })) + (RamDomain(1)))}});
rel_6_new_haschild->insert(tuple,READ_OP_CONTEXT(rel_6_new_haschild_op_ctxt));
}
}
}
...
SignalHandler::instance()->setMsg(R"_(haschild(v0,v1,6,(max(max(@level_num_0,@level_num_1),@level_num_2)+1)) :- 
   ...
   ismarriedto(v0,v2,_,@level_num_1),
   haschild(v1,v2,_,@level_num_2).
in file /home/johannes_tantow/DatalogLearning/prosynth/family/sol_haschild.dl [23:1-23:70])_");
if(!(rel_5_delta_haschild->empty()) && !(rel_3_ismarriedto->empty()) && !(rel_2_Rule->empty())) {
[&](){
...
SignalHandler::instance()->setMsg(R"_(haschild.@info.1(1,"v0,v1","Rule","ismarriedto,v0,v1","haschild(v0,v1) :- 
   ...
   ismarriedto(v0,v1).").
in file  [0:0-0:0])_");
rel_7_haschild_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3));
}();
/* END STRATUM 4 */
/* BEGIN STRATUM 5 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.2(2,"v0,v1","Rule","ismarriedto,v2,v0","haschild,v1,v2","haschild(v0,v1) :- 
   ...
   haschild(v1,v2).").
in file  [0:0-0:0])_");
rel_8_haschild_info_2->insert(RamDomain(2),RamDomain(0),RamDomain(1),RamDomain(4),RamDomain(5),RamDomain(6));
}();
/* END STRATUM 5 */
/* BEGIN STRATUM 6 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.3(3,"v0,v1","Rule","ismarriedto,v1,v2","haschild,v2,v0","haschild(v0,v1) :- 
   Rule(127),
   ismarriedto(v1,v2),
   haschild(v2,v0).").
in file  [0:0-0:0])_");
rel_9_haschild_info_3->insert(RamDomain(3),RamDomain(0),RamDomain(1),RamDomain(7),RamDomain(8),RamDomain(9));
}();
/* END STRATUM 6 */
/* BEGIN STRATUM 7 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.4(4,"v0,v1","Rule","ismarriedto,v0,v2","ismarriedto,v1,v2","haschild(v0,v1) :- 
   ...
   ismarriedto(v1,v2).").
in file  [0:0-0:0])_");
rel_10_haschild_info_4->insert(RamDomain(4),RamDomain(0),RamDomain(1),RamDomain(10),RamDomain(7),RamDomain(11));
}();
/* END STRATUM 7 */
/* BEGIN STRATUM 8 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.5(5,"v0,v1","Rule","ismarriedto,v1,v2","Ihaschild,v2,v0","haschild(v0,v1) :- 
   ...
   Ihaschild(v2,v0).").
in file  [0:0-0:0])_");
rel_11_haschild_info_5->insert(RamDomain(5),RamDomain(0),RamDomain(1),RamDomain(7),RamDomain(12),RamDomain(13));
}();
/* END STRATUM 8 */
/* BEGIN STRATUM 9 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.6(6,"v0,v1","Rule","ismarriedto,v0,v2","haschild,v1,v2","haschild(v0,v1) :- 
   Rule(130),
   ismarriedto(v0,v2),
   haschild(v1,v2).").
in file  [0:0-0:0])_");
rel_12_haschild_info_6->insert(RamDomain(6),RamDomain(0),RamDomain(1),RamDomain(10),RamDomain(5),RamDomain(14));
}();
/* END STRATUM 9 */
/* BEGIN STRATUM 10 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.7(7,"v0,v1","Rule","ismarriedto,v2,v1","Ihaschild,v2,v0","haschild(v0,v1) :- 
   Rule(108),
   ismarriedto(v2,v1),
   Ihaschild(v2,v0).").
in file  [0:0-0:0])_");
rel_13_haschild_info_7->insert(RamDomain(7),RamDomain(0),RamDomain(1),RamDomain(15),RamDomain(12),RamDomain(16));
}();
/* END STRATUM 10 */
/* BEGIN STRATUM 11 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.8(8,"v0,v1","Rule","ismarriedto,v2,v0","Ihaschild,v2,v1","haschild(v0,v1) :- 
   Rule(105),
   ismarriedto(v2,v0),
   Ihaschild(v2,v1).").
in file  [0:0-0:0])_");
rel_14_haschild_info_8->insert(RamDomain(8),RamDomain(0),RamDomain(1),RamDomain(4),RamDomain(17),RamDomain(18));
}();
/* END STRATUM 11 */
/* BEGIN STRATUM 12 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.9(9,"v0,v1","Rule","ismarriedto,v2,v0","Ihaschild,v1,v2","haschild(v0,v1) :- 
   Rule(104),
   ismarriedto(v2,v0),
   Ihaschild(v1,v2).").
in file  [0:0-0:0])_");
rel_15_haschild_info_9->insert(RamDomain(9),RamDomain(0),RamDomain(1),RamDomain(4),RamDomain(19),RamDomain(20));
}();
/* END STRATUM 12 */
/* BEGIN STRATUM 13 */
[&]() {
