...
// -- Table: isCitizenOf
std::unique_ptr<t_btree_4__0_1_2_3__3__15> rel_2_isCitizenOf = std::make_unique<t_btree_4__0_1_2_3__3__15>();
souffle::RelationWrapper<1,t_btree_4__0_1_2_3__3__15,Tuple<RamDomain,4>,4> wrapper_rel_2_isCitizenOf;
// -- Table: livesIn
std::unique_ptr<t_btree_4__0_1_2_3__15> rel_3_livesIn = std::make_unique<t_btree_4__0_1_2_3__15>();
souffle::RelationWrapper<2,t_btree_4__0_1_2_3__15,Tuple<RamDomain,4>,4> wrapper_rel_3_livesIn;
// -- Table: livesIn.@info.1
std::unique_ptr<t_btree_5__0_1_2_3_4__31> rel_4_livesIn_info_1 = std::make_unique<t_btree_5__0_1_2_3_4__31>();
souffle::RelationWrapper<3,t_btree_5__0_1_2_3_4__31,Tuple<RamDomain,5>,5> wrapper_rel_4_livesIn_info_1;
public:
Sf_program_small() : 
...
wrapper_rel_2_isCitizenOf(*rel_2_isCitizenOf,symTable,"isCitizenOf",std::array<const char *,4>{{"s:V","s:V","i:number","i:number"}},std::array<const char *,4>{{"v0","v1","@rule_number","@level_number"}}),
...
wrapper_rel_4_livesIn_info_1(*rel_4_livesIn_info_1,symTable,"livesIn.@info.1",std::array<const char *,5>{{"i:number","s:symbol","s:symbol","s:symbol","s:symbol"}},std::array<const char *,5>{{"clause_num","head_vars","rel_0","rel_1","clause_repr"}}){
addRelation("Rule",&wrapper_rel_1_Rule,true,false);
addRelation("isCitizenOf",&wrapper_rel_2_isCitizenOf,true,false);
addRelation("livesIn",&wrapper_rel_3_livesIn,false,true);
addRelation("livesIn.@info.1",&wrapper_rel_4_livesIn_info_1,false,false);
}
~Sf_program_small() {
}
private:
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->readAll(*rel_2_isCitizenOf);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
}();
/* END STRATUM 1 */
...
in file /home/johannes/test/popl2020-artifact/prosynth/livesIn/solution.dl [18:1-18:49])_");
if(!(rel_2_isCitizenOf->empty()) && !(rel_1_Rule->empty())) {
[&](){
...
CREATE_OP_CONTEXT(rel_2_isCitizenOf_op_ctxt,rel_2_isCitizenOf->createContext());
CREATE_OP_CONTEXT(rel_3_livesIn_op_ctxt,rel_3_livesIn->createContext());
pfor(auto it = part.begin(); it<part.end(); ++it) { 
try{
for(const auto& env0 : *it) {
for(const auto& env1 : *rel_2_isCitizenOf) {
...
rel_3_livesIn->insert(tuple,READ_OP_CONTEXT(rel_3_livesIn_op_ctxt));
}
}
...
SignalHandler::instance()->setMsg(R"_(livesIn.@info.1(1,"v0,v1","Rule","isCitizenOf,v0,v1","livesIn(v0,v1) :- 
   ...
   isCitizenOf(v0,v1).").
in file  [0:0-0:0])_");
rel_4_livesIn_info_1->insert(RamDomain(1),RamDomain(0),RamDomain(1),RamDomain(2),RamDomain(3));
}();
/* END STRATUM 3 */
...
std::cout << "\n";
std::cout << "Relation rel_2_isCitizenOf:\n";
rel_2_isCitizenOf->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_3_livesIn:\n";
rel_3_livesIn->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_4_livesIn_info_1:\n";
rel_4_livesIn_info_1->printHintStatistics(std::cout,"  ");
std::cout << "\n";
}
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_2_isCitizenOf");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0}), symTable, ioDirectives, true)->writeAll(*rel_2_isCitizenOf);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
public:
...
();[&](){
CREATE_OP_CONTEXT(rel_2_isCitizenOf_op_ctxt,rel_2_isCitizenOf->createContext());
if(!rel_2_isCitizenOf->equalRange_3(Tuple<RamDomain,4>({{(args)[0],(args)[1],0,0}}),READ_OP_CONTEXT(rel_2_isCitizenOf_op_ctxt)).empty()) {
std::lock_guard<std::mutex> guard(lock);
...
auto range = rel_2_isCitizenOf->equalRange_3(key,READ_OP_CONTEXT(rel_2_isCitizenOf_op_ctxt));
