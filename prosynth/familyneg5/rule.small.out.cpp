...
in file /home/johannes/DatalogLearning/prosynth/familyneg5/rule.dl [35:1-35:71])_");
...
/* BEGIN STRATUM 4 */
[&]() {
SignalHandler::instance()->setMsg(R"_(haschild.@info.1(1,"v0,v1","Rule","ismarriedto,v2,v0","Ihaschild,v2,v1","haschild(v0,v1) :- 
   Rule(105),
   ismarriedto(v2,v0),
   Ihaschild(v2,v1).").
in file  [0:0-0:0])_");
